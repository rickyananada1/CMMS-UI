...
const LocationForm = ({ mode, setAction, setTabIndex }) => {
  ...
  return (
    ...
    >
      {({ handleChange, setFieldValue, isSubmitting, values, errors, touched, isValid, dirty }) => {
        return (
          <Form>
            <DetailCard>
              <div>
                ...
                <CRow>
                  <CCol sm={12} md={3}>
                    ...
                    {errors?.location?.location && touched?.location?.location ? (
                      <div className="text-sm text-[#b03434] mt-1">{errors.location?.location}</div>
                    ) : null}
                  </CCol>
                  <CCol sm={12} md={3}>
                    <CFormLabel className="text-primary fw-semibold">
                ...
                <CRow className="mt-4">
                  ...
                  <CCol sm={12} md={3}>
                    ...
                    <Field
                      ...
                      as={CFormInput}
                    />
                    {errors?.location?.location_priority && touched?.location?.location_priority ? (
                      <div className="text-sm text-[#b03434] mt-1">
                ...
                <CRow className="mt-4">
                  <CCol sm={12} md={3}>
                    ...
                    <Field
                      ...
                      isClearable
                    />
                    {errors?.location?.failure_class && touched?.location?.failure_class?.value ? (
                      <div className="text-sm text-[#b03434] mt-1">
