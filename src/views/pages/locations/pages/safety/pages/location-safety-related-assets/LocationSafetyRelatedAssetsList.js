...
import useLocationSafetyRelatedAssetsList from './hooks/useLocationSafetyRelatedAssetsList'
import { useGetLocationSafetyRelatedAssetsTableList } from './services'
...
const LocationSafetyRelatedAssetsList = ({
  mode,
  setAction,
  setTabIndex,
  isRefetchList,
  ...
  const { tableRef, selectedRow } = useLocationSafetyRelatedAssetsList({
    mode,
    setAction,
    setTabIndex,
    isRefetchList,
    ...
    <div>
      <DetailCard>
        ...
        <Table
          ...
          apiController={useGetLocationSafetyRelatedAssetsTableList}
          query={{
...
export default LocationSafetyRelatedAssetsList
