...
import useLocationSafetyRelatedAssetsForm from './hooks/useLocationSafetyRelatedAssetsForm'
import { locationSafetyRelatedAssetsSchema } from './schema/locationSafetyRelatedAssetsSchema'

const LocationSafetyRelatedAssetsForm = ({ mode, setAction, setTabIndex }) => {
  const { formValue, getAssets, handleSubmit } = useLocationSafetyRelatedAssetsForm({
    mode,
    setAction,
    setTabIndex,
  })
  ...
  return (
    <div>
      <Formik
        ...
        validationSchema={locationSafetyRelatedAssetsSchema}
...
export default LocationSafetyRelatedAssetsForm
