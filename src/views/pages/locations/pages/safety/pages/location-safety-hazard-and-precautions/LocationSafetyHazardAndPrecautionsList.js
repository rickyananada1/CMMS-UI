...
import { useGetLocationSafetyHazardAndPrecautionsTableList } from './services'
import useLocationSafetyHazardAndPrecautionsList from './hooks/useLocationSafetyHazardAndPrecautionsList'
  ...
  return (
    <div className="bg-[#E9F1FB80] px-5 py-3">
      ...
      <div className="grid grid-cols-4 mb-3">
        <div>
          <label className="text-body-small font-light">Hazard</label>
        ...
        <div>
          <label className="text-body-small font-light mb-2">Can Have Hazardous Materials ?</label>
          <img
        ...
        <div>
          <label className="text-body-small font-light">Type</label>
          <p className="text-body-bold">
        ...
        <Fragment>
          ...
          {data?.precautions.map((item, index) => (
            <div key={`precautions-${item?.precaution_id}`} className="grid grid-cols-4 mb-3">
              <div>
                <label className="text-body-small font-light">Precautions Code {index + 1}</label>
                <p className="text-body-bold">
                  {item?.precaution_code ? item?.precaution_code : '-'}
                </p>
              </div>
              <div>
                <label className="text-body-small font-light">
...
const LocationSafetyHazardAndPrecautionsList = ({
  mode,
  setAction,
  setTabIndex,
  isRefetchList,
  ...
  const {
    ...
    handleSearch,
    searchDebounce,
  } = useLocationSafetyHazardAndPrecautionsList({
    mode,
    setAction,
    setTabIndex,
    isRefetchList,
      ...
      <DetailCard>
        ...
        <div className="flex justify-between items-center">
          ...
          <button
            ...
            onClick={downloadLocationSafetyHazardAndPrecautions}
          >
        ...
        <Table
          ...
          apiController={useGetLocationSafetyHazardAndPrecautionsTableList}
          query={{
...
export default LocationSafetyHazardAndPrecautionsList
