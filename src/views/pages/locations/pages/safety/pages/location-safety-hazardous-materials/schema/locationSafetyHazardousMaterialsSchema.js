...
const locationSafetyHazardousMaterialsSchema = Yup.object().shape({
  location_hazardous_materials: Yup.array().of(
    Yup.object().shape({
...
const locationSafetyHazardousMaterialsDeleteSchema = Yup.object().shape({
...
export { locationSafetyHazardousMaterialsSchema, locationSafetyHazardousMaterialsDeleteSchema }
