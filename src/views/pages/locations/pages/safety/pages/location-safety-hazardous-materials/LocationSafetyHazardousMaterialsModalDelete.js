...
import useLocationSafetyHazardousMaterialsDelete from './hooks/useLocationSafetyHazardousMaterialsDelete'
import { Field, Form, Formik } from 'formik'
import { SelectPagination } from 'src/components/elements/select'
import { locationSafetyHazardousMaterialsDeleteSchema } from './schema/locationSafetyHazardousMaterialsSchema'

const LocationSafetyHazardousMaterialsModalDelete = ({
  mode,
  setAction,
  visible,
  setVisible,
  ...
  const { formValue, selectedRow, handleDelete, listHazardAndPrecautionService } =
    useLocationSafetyHazardousMaterialsDelete({
      mode,
      setTabIndex,
      setAction,
      visible,
  ...
  return (
    <CModal alignment="center" visible={visible} onClick={() => setVisible(false)}>
      <Formik
        ...
        validationSchema={locationSafetyHazardousMaterialsDeleteSchema}
...
export default LocationSafetyHazardousMaterialsModalDelete
