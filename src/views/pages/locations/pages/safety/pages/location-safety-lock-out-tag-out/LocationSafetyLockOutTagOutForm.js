...
import useLocationSafetyLockOutTagOutForm from './hooks/useLocationSafetyLockOutTagOutForm'
...
} from './schema/locationSafetyLockOutTagOutSchema'
...
const LocationSafetyHazardAndPrecautionsForm = ({ mode, setAction, setTabIndex }) => {
  const {
    ...
    handleSubmit,
  } = useLocationSafetyLockOutTagOutForm({
    mode,
    setAction,
    setTabIndex,
  })
  ...
  return (
    <div>
      <Formik
        ...
        validationSchema={
          isOnEdit ? locationSafetyLockOutTagOutEditSchema : locationSafetyLockOutTagOutSchema
        }
          ...
          return (
            <Form>
              <DetailCard>
                ...
                <FieldArray
                  name="location_safety_lock_out_tag_out"
                  render={(arrayHelpers) =>
                    values.location_safety_lock_out_tag_out.map((item, index) => {
                      return (
                        <div className="my-2" key={`${index}-new-hazard-tag-out`}>
                          {!isOnEdit ? (
                            <div className="flex">
                              ...
                              {values.location_safety_lock_out_tag_out.length > 1 && (
                                <CButton
                                  color="danger"
                                  variant="outline"
                          ...
                          <div className="my-4">
                            ...
                            <div className="row">
                              <div className="col-md-3 mb-4">
                                ...
                                <Field
                                  name={`location_safety_lock_out_tag_out.${index}.hazard`}
                                  placeholder="Choose Hazard"
                                  value={item?.hazard}
                                  apiController={getLocationSafetyHazardsTagOut}
                                  ...
                                  onChange={(val) => {
                                    setFieldValue(
                                      `location_safety_lock_out_tag_out.${index}.hazard`,
                                      val,
                                    )
                                  }}
                                  valueKey={'hazard'}
                                  ...
                                  as={SelectPagination}
                                />
                                {errors?.location_safety_lock_out_tag_out &&
                                errors?.location_safety_lock_out_tag_out[index]?.hazard &&
                                touched?.location_safety_lock_out_tag_out &&
                                touched?.location_safety_lock_out_tag_out[index]?.hazard ? (
                                  <div className="text-sm text-[#b03434] mt-1">
                                    {errors.location_safety_lock_out_tag_out[index]?.hazard?.value}
                                  </div>
                                ) : null}
                              </div>
                              <div className="col-md-3 mb-4">
                                ...
                                <Field
                                  name={`location_safety_lock_out_tag_out.${index}.hazard.hazard_desc`}
                              ...
                              <div className="col-md-3 mb-4">
                                ...
                                <Field
                                  name={`location_safety_lock_out_tag_out.${index}.hazard.msds`}
                            ...
                            {isOnEdit && !item?.tag_out ? (
                              <div className="w-full mb-2">
                                <CButton
                                  ...
                                  onClick={() => {
                                    setFieldValue(
                                      `location_safety_lock_out_tag_out.${index}.tag_out`,
                                      {
                                        label: '',
                                        value: '',
                                      },
                              ...
                              <Fragment>
                                ...
                                <div className="row">
                                  <div className="col-md-3 mb-4">
                                    ...
                                    <Field
                                      name={`location_safety_lock_out_tag_out.${index}.tag_out`}
                                      placeholder="Choose Tag Out"
                                      value={item.tag_out}
                                      apiController={getLocationSafetyTagOut}
                                      valueKey={'tag_out'}
                                      labelKey={'tag_out'}
                                    ...
                                    />
                                    {errors?.location_safety_lock_out_tag_out &&
                                    errors?.location_safety_lock_out_tag_out[index]?.tag_out &&
                                    touched?.location_safety_lock_out_tag_out &&
                                    touched?.location_safety_lock_out_tag_out[index]?.tag_out ? (
                                      <div className="text-sm text-[#b03434] mt-1">
                                        {
                                          errors.location_safety_lock_out_tag_out[index]?.tag_out
                                            ?.value
                                  ...
                                  <div className="col-md-3 mb-4">
                                    ...
                                    <Field
                                      name={`location_safety_lock_out_tag_out.${index}.tag_out_code`}
                                  ...
                                  <div className="col-md-3 mb-4">
                                    ...
                                    <Field
                                      name={`location_safety_lock_out_tag_out.${index}.tag_out.apply_sequence`}
                                      placeholder="Enter Apply Sequence"
                                      value={item?.tag_out?.apply_sequence}
                                      onChange={(event) =>
                                        setFieldValue(
                                          `location_safety_lock_out_tag_out.${index}.tag_out.apply_sequence`,
                                          event.target?.value,
                                        )
                                      }
                                      size="md"
                                  ...
                                  <div className="col-md-3 mb-4">
                                    ...
                                    <Field
                                      name={`location_safety_lock_out_tag_out.${index}.tag_out.remove_sequence`}
                                      placeholder="Enter Remove Sequence"
                                      value={item?.tag_out?.remove_sequence}
                                      onChange={(event) =>
                                        setFieldValue(
                                          `location_safety_lock_out_tag_out.${index}.tag_out.remove_sequence`,
                                          event.target?.value,
                                        )
                                      }
                                      size="md"
                                ...
                                <div className="row">
                                  <div className="col-md-3 mb-4">
                                    ...
                                    <Field
                                      ...
                                      value={item?.tag_out?.value ? selectedRow?.location : null}
                                      size="md"
                                      disabled
                                      as={CFormInput}
                                    />
                                ...
                                <FieldArray
                                  name={`location_safety_lock_out_tag_out.${index}.lock_out`}
                                  render={() =>
                                        ...
                                        return (
                                          ...
                                          >
                                            ...
                                            <div className="col-md-3 mb-4">
                                              ...
                                              <Field
                                                name={`location_safety_lock_out_tag_out.${index}.lock_out.${indexLock}.lock_out`}
                                            ...
                                            <div className="col-md-3 mb-4">
                                              ...
                                              <Field
                                                name={`location_safety_lock_out_tag_out.${index}.lock_out.${indexLock}.apply_sequence`}
                                                placeholder="Enter Apply Sequence"
                                            ...
                                            <div className="col-md-3 mb-4">
                                              ...
                                              <Field
                                                name={`location_safety_lock_out_tag_out.${index}.lock_out.${indexLock}.remove_sequence`}
                                                placeholder="Enter Remove Sequence"
                            ...
                            {!isOnEdit ? (
                              <Fragment>
                                ...
                                <div className="w-full">
                                  {index + 1 === values.location_safety_lock_out_tag_out.length && (
                                    <CButton
                                      color="primary"
                                      variant="outline"
                                      className="hover:text-white"
