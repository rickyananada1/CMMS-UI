...
import useMetersCondition from './hooks/useMetersCondition'
import { CCol, CContainer, CRow } from '@coreui/react'
import { DetailCard } from 'src/components/elements/cards'
import { Table } from 'src/components/elements/table'
import { useGetMeterCondition } from './services'
import { MdOutlineCloudDownload } from 'react-icons/md'
import { GoSearch } from 'react-icons/go'
import CardHeader from 'src/components/elements/cards/CardHeader'

const MetersCondition = ({ mode, setAction, setTabIndex }) => {
  const { tableRef, selectedRow, downloadMeterCondition, searchDebounce, handleSearch } =
    useMetersCondition({
      mode,
      setAction,
      setTabIndex,
      ...
      <CContainer fluid>
        ...
        <div className="flex items-center justify-between">
          ...
          <button
            ...
            onClick={downloadMeterCondition}
          >
        ...
        <Table
          ...
          apiController={useGetMeterCondition}
          query={{
...
export default MetersCondition
