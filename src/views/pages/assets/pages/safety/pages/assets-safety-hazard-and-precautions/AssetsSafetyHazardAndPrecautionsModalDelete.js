...
import useAssetsSafetyHazardAndPrecautionsDelete from './hooks/useAssetsSafetyHazardAndPrecautionsDelete'
import { Field, Form, Formik } from 'formik'
import { SelectPagination } from 'src/components/elements/select'
import { assetsSafetyHazardAndPrecautionsDeleteSchema } from './schema/assetsSafetyHazardAndPrecautionsSchema'

const AssetsSafetyHazardAndPrecautionsModalDelete = ({
  mode,
  setAction,
  visible,
  setVisible,
  ...
  const { formValue, selectedRow, handleDelete, listHazardAndPrecautionService } =
    useAssetsSafetyHazardAndPrecautionsDelete({
      mode,
      setTabIndex,
      setAction,
      visible,
  ...
  return (
    <CModal alignment="center" visible={visible} onClose={() => setVisible(false)}>
      <Formik
        ...
        validationSchema={assetsSafetyHazardAndPrecautionsDeleteSchema}
...
export default AssetsSafetyHazardAndPrecautionsModalDelete
