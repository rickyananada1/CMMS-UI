...
import {
  useDeleteAssetsSafetyHazardAndPrecautions,
  useGetAssetsSafetyHazardAndPrecautionsList,
} from '../services'
import { useSelector } from 'react-redux'

const useAssetsSafetyHazardAndPrecautionsDelete = ({
  setAction,
  setTabIndex,
  setVisible,
  setIsRefetchList,
  ...
  const listHazardAndPrecautionService = useGetAssetsSafetyHazardAndPrecautionsList({
    id: selectedRow?.asset_id,
  })

  const deleteAssetsService = useDeleteAssetsSafetyHazardAndPrecautions({
    id: selectedRow?.asset_id,
  })
...
export default useAssetsSafetyHazardAndPrecautionsDelete
