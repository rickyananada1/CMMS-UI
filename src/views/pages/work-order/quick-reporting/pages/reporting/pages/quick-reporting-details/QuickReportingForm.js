...
const QuickReportingForm = ({ mode, setAction, setTabIndex }) => {
  const {
    formValue,
    isLoading,
    handleSubmit,
              ...
              <DetailCard isLoading={isLoading}>
                ...
                <CContainer fluid>
                  ...
                  <CRow className="mt-4">
                    <CCol>
                      <CFormLabel className="text-primary fw-semibold">
                        Assign Person <span className="text-red-main">*</span>
                      </CFormLabel>
                      <Field
                        name="assign_person"
                        placeholder="Enter Assign Person"
                        value={values?.assign_person}
                        invalid={touched.assign_person && errors.assign_person}
                        onChange={handleChange}
                        size="md"
                        as={CFormInput}
                        disabled={disableEdit}
                      />
                      {errors.assign_person && touched.assign_person ? (
                        <div className="text-sm text-[#e55353] mt-1">{errors.assign_person}</div>
                      ) : null}
                    </CCol>
                    <CCol>
                      <CFormLabel className="text-primary fw-semibold">
                        Lead <span className="text-red-main">*</span>
                      </CFormLabel>
                      <Field
                        name="lead"
                        placeholder="Enter Lead"
                        value={values?.lead}
                        invalid={touched.lead && errors.lead}
                        onChange={handleChange}
                        size="md"
                        as={CFormInput}
                        disabled={disableEdit}
                      ...
                      {errors.lead && touched.lead ? (
                        <div className="text-sm text-[#e55353] mt-1">{errors.lead}</div>
                      ) : null}
                    </CCol>
                    <CCol>
                      <CFormLabel className="text-primary fw-semibold">
                    ...
                    <CCol>
                      <CFormLabel className="text-primary fw-semibold">
                        Work Group <span className="text-red-main">*</span>
                      </CFormLabel>
                      <Field
                        name="workgroup"
                        placeholder="Enter Work Group"
                        value={values?.workgroup}
                        invalid={touched.workgroup && errors.workgroup}
                        onChange={handleChange}
                        size="md"
                        as={CFormInput}
                        disabled={disableEdit}
                      />
                      {errors.workgroup && touched.workgroup ? (
                        <div className="text-sm text-[#e55353] mt-1">{errors.workgroup}</div>
                      ) : null}
                    </CCol>
                  </CRow>
                  <CRow className="mt-4">
                  ...
                  <CRow>
                    <CCol>
                      ...
                      <Field
                        ...
                        as={SelectPagination}
                        isClearable
                        disabled={values?.pm_id?.value || disableEdit}
                      />
...
export default QuickReportingForm
