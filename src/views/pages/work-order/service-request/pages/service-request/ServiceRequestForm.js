    ...
    >
      {({
        ...
        const handleLocationChange = (val) => {
          ...
          console.log("LOCATION SET:", formatted);
        };
        ...
        //     console.log('handleAssetChange val:', val);
        ...
        const handleAssetChange = (val) => {
          ...
          if (!isLocationChanged && val?.location) {
            ...
            console.log("AUTO SET LOCATION:", formatted);
        ...
        { console.log('value sent to Select:', values.location_id) }
              ...
              <CContainer fluid>
                ...
                <CRow>
                  <CCol>
                    ...
                    {console.log("VALUE:", values.detailsummary)}
                ...
                <CRow className="mb-3">
                  ...
                  <CCol>
                    ...
                    <Field
                      ...
                      labelFormat={(item) => `${item?.location_id ?? ''} - ${item?.location_description ?? ''}`}
                      size="md"
                      as={SelectPagination}
                      isClearable
