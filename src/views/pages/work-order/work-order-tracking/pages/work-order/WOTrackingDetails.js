...
const WOTrackingDetails = ({ mode, setAction, setTabIndex, setVisible }) => {
  const {
    data,
    isLoading,
    dataFile,
      ...
      <DetailCard isLoading={isLoading}>
        <CardHeader
          ...
          infoFields={[
            ...
            { label: 'Parent WO', value: data?.parent_wo },
        ...
        <CContainer fluid>
          ...
          <CRow className="mt-4">
            <CCol>
              ...
              <br />
              <span className="font-semibold">{data?.vendor_id ?? '-'}</span>
            </CCol>
            <CCol>
              <label className="text-neutral-text-field">Vendor Description</label>
              <br />
              <span className="font-semibold">{data?.vendor_description ?? '-'}</span>
            </CCol>
            <CCol>
          ...
          <CRow className="mt-4">
            ...
            <CCol>
              <label className="text-neutral-text-field">Class</label>
              <br />
            ...
            <CCol>
              ...
              <br />
              <span className="font-semibold">{data?.work_priority ?? '-'}</span>
            </CCol>
          </CRow>
          <CRow className="mt-4">
            <CCol>
            ...
            <CCol>
              <label className="text-neutral-text-field">Problem Code</label>
              <br />
              <span className="font-semibold">{data?.problem ?? '-'}</span>
            </CCol>
            <CCol></CCol>
          </CRow>
          <CRow className="mt-4">
            ...
            <CCol>
              ...
              <span className="font-semibold">
                {moment(data?.status_date).format('DD/MM/YYYY HH:mm [WIB]') ?? '-'}
              </span>
            </CCol>
            <CCol>
          ...
          <CRow className="mt-4">
            <CCol>
              <label className="text-neutral-text-field">Need Safety Approval?</label>
              <br />
              <img
                src={data?.need_safety_approval ? CheckTag : XTag}
                width={15}
                height={15}
                alt={data?.need_safety_approval}
              />
            </CCol>
            <CCol>
              <label className="text-neutral-text-field">Is Task?</label>
              <br />
              <img
                src={data?.is_task ? CheckTag : XTag}
                width={15}
                height={15}
                alt={data?.is_task}
              />
            ...
            <CCol>
              <label className="text-neutral-text-field">Asset Up?</label>
              <br />
              <img
                src={data?.asset_up ? CheckTag : XTag}
                width={15}
                height={15}
                alt={data?.asset_up}
              />
...
export default WOTrackingDetails
