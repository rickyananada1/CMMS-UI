...
import { woLaborActions } from './pages/labor-materials-tools/slices/woLaborSlices'
import { woMaterialsActions } from './pages/labor-materials-tools/slices/woMaterialsSlices'
import { woToolsActions } from './pages/labor-materials-tools/slices/woToolsSlices'

const WOPlansTab = (props) => {
  const dispatch = useDispatch()

  const { selectedTab, setSelectedTab } = usePlansTab()
