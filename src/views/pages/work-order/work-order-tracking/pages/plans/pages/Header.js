    ...
    <div className="flex items-center justify-between">
      <div>
        <h4 className="w-full font-semibold">
          {props?.work_order_description ? props?.work_order_description : '-'}
        </h4>
        <p className="text-neutral">
          ...
          <span className="text-neutral-text-disabled">Parent WO : </span>
          <span className="text-body-bold">{props?.parent_wo ? props?.parent_wo : '-'}</span>
          <span className="text-neutral-text-disabled"> / </span>
