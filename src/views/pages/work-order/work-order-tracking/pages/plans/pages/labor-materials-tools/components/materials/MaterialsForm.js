...
import useMaterialsForm from '../../hooks/useMaterialForm'

const MaterialsForm = ({ mode, setAction }) => {
  const { initialValue, textFields, handleAddTextField, handleRemoveTextField } = useMaterialsForm()
                  ...
                  <CTableRow>
                    <CTableDataCell>
                      <h4 className="text-body-bold">
                        {(mode === 'Create' && 'New Materials') || 'Edit Materials'}
                      </h4>
                      <p className="text-neutral-text-disabled">
                        {(mode === 'Create' && 'Fill this column to add New Materials') ||
                          'Fill this column to add Edit Materials'}
                      </p>
                    </CTableDataCell>
                  </CTableRow>
                        ...
                        <div className="mt-3">
                          ...
                          <div className="mb-3">
                            <div className="grid grid-cols-4 my-3">
                              ...
                              <div className="mr-3  mt-4">
                                <CFormLabel className="text-primary fw-semibold">
                                  Storeroom <span className="text-red-main">*</span>
                                </CFormLabel>
                                <Field
                                  name="task_id"
                                  placeholder="Enter Line Cost"
