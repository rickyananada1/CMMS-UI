...
const TaskForWorkOrderForm = ({ mode, setAction }) => {
  const { optionsStatus, setField, setChange, textFields, handleSubmit } = useTaskForWorkOrderForm({
    mode,
    setAction,
  })
            ...
            <Fragment>
              <DetailCard>
                ...
                <div className="grid grid-cols-4 my-1">
                  ...
                  <div className="mr-3 mt-3">
                    <CFormLabel className="text-primary fw-semibold">Measurement Point</CFormLabel>
                    <Field
                  ...
                  <div className="mr-3 mt-3">
                    <CFormLabel className="text-primary fw-semibold">Measurement Value</CFormLabel>
                    <Field
