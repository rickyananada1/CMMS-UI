...
import { laborSchema } from '../../schema/laborMaterialsToolsSchema'
              ...
              <div className="flex justify-between items-center">
                <div>
                  <h4 className="text-body-bold">
                    {(mode === 'Create Labor' && 'New Actuals Labor') || 'Edit Actuals Labor'}
                  </h4>
                  <p className="text-neutral-text-disabled">
                    {(mode === 'Create Labor' && 'Fill this column to Create New Actuals Labor') ||
                      'Fill this column to Edit Actuals Labor'}
                  </p>
                </div>
              </div>
              <hr className="py-1" />
