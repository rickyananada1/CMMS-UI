...
import { useGetSpareparts } from '../../../../services'
...
const useMaterialsForm = ({ mode, setAction }) => {
  ...
  const getDetailWorkOrderMaterialsService = useGetDetailMaterials({
    ...
    material_actual_id: selectedMaterialsRow?.work_order_material_actual_id,
  })
  ...
  const handleUpdateMaterials = async (values) => {
    ...
    await updateMaterials
      .mutateAsync({
        ...
        material_id: selectedMaterialsRow?.work_order_material_actual_id,
      })
      .then((response) => {
