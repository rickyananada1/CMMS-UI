...
import { materialsSchema } from '../../schema/laborMaterialsToolsSchema'
              ...
              <div className="flex justify-between items-center">
                <div>
                  <h4 className="text-body-bold">
                    {(mode === 'Create Materials' && 'New Actuals Materials') ||
                      'Edit Actuals Materials'}
                  </h4>
                  <p className="text-neutral-text-disabled">
                    {(mode === 'Create Materials' &&
                      'Fill this column to Create New Actuals Materials') ||
                      'Fill this column to Edit Actuals Materials'}
                  </p>
                </div>
              </div>
              <hr className="py-1" />
