...
import { useGetChildOfWorkOrder } from './services'
    ...
    <DetailCard>
      ...
      <Table
        ...
        selectableRowSelected={(row) =>
          row.original?.work_order_plan_actual_id === selectedChildernRow?.work_order_plan_actual_id
        }
        onRowClicked={(row) => {
    ...
    <div className="bg-[#E9F1FB80] px-5 py-3">
      ...
      <div className="grid grid-cols-4 my-3">
        ...
        <div>
          ...
          <p className="text-body-bold">{data?.location ? data.location : '-'}</p>
        </div>
        <div>
        ...
        <div>
          ...
          <p className="text-body-bold">
            {data?.job_plan_id ? data?.job_plan_name ?? data?.job_plan_id : '-'}
          </p>
        </div>
        <div>
